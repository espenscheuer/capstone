      ...
      <Row>
        ...
        <Col xs={{ span: 22 }} lg={{ span: 22 }}>
          ...
          <Row justify="space-around" align="middle" gutter={30}>
            <Col xs={{ span: 24 }} lg={{ span: 12 }}>
              ...
              <p>
                ...
                experiences of associates. We talked with 4 different associates
                from various e-commerce companies.
              </p>
            </Col>
            <Col xs={{ span: 24 }} lg={{ span: 12 }}>
              {images && (
          ...
          <List>
            ...
            <List.Item>
              CX associates need to balance efficiency and personalization while
          ...
          <p>
            In order to analyze our research results we created an extensive set
            of Jobs-To-Be-Done for each task we learned about, we then
          ...
          <p>
            A user shopping online reaches out to customer service because they
            would like to change their order.
          </p>
          <p>
          ...
          <br />
          <p>
            During this phase we jumped heavily into design. We took our designs
            through three levels of fidelity, sketching, wireframing, and medium
            fidelity.
          </p>
          <br />
          <Row justify="space-around" align="middle" gutter={30}>
          ...
          <Row justify="space-around" align="middle" gutter={30}>
            ...
            <Col xs={{ span: 24 }} lg={{ span: 12 }}>
              ...
              <p>
                {" "}
                We used wireframes to map out the scenario, understanding how a
                ticket escalation would look inside the tool we were designing.
              </p>
            </Col>
          </Row>
          <br />
          ...
          <Row justify="space-around" align="middle" gutter={30}>
            <Col xs={{ span: 24 }} lg={{ span: 12 }}>
              ...
              <p>
                {" "}
                For further review we leveraged Microsofts extensive library of
                components to bring our designs to medium fidelity, getting an
                idea of what our solution would actually look like.
              </p>
            </Col>
            <Col xs={{ span: 24 }} lg={{ span: 12 }}>
              {images && (
          ...
          <p>
            For usability testing we reached out to 4 people working in customer
            experience. We recieved a ton of feedback which is displayed below
            broken down into validation, and areas for improvement.
          </p>
          <br />
          <p>
            <b>Validation</b>
          ...
          <p>
            ...
            designs, a hi-fidelity flow that takes users through the process of
            escalating and resolving a customer support ticket. You can see this
            in a clickable prototype in the Deliverable tab.
          </p>
          <br />
          <Row>
            <Col span={3}></Col>
          ...
          <p>
            In line with Micorosft accessibility guidelines we created tabbing documentations for our designs.
          </p>
          <br />
          <Row>
            <Col span={3}></Col>
